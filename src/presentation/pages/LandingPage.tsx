      ...
      <header className="fixed top-0 left-0 right-0 h-16 bg-[#020617]/90 dark:bg-[#020617]/90 light:bg-white/95 backdrop-blur-md border-b border-slate-800 dark:border-slate-800 light:border-slate-200 flex items-center justify-between px-4 sm:px-6 z-50 transition-colors">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button 
            ...
            className="px-4 py-2 text-xs font-bold text-white bg-blue-700 hover:bg-blue-800 rounded-xl transition-all shadow-md cursor-pointer"
          >
            Criar conta grátis
          </button>
        </div>
        ...
        <section className="py-12 sm:py-16 px-6 max-w-7xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-700 dark:text-blue-400 text-xs font-bold font-mono">
                <Sparkles size={14} />
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button
                  onClick={() => onNavigateToAuth('signup')}
                  className="px-6 py-3.5 text-sm font-bold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 rounded-xl transition-all shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2 cursor-pointer focus:ring-2 focus:ring-blue-500 focus:outline-none"
                >
        ...
        <section id="planos" className="py-16 px-6 max-w-7xl mx-auto border-t border-slate-800/60 dark:border-slate-800/60 light:border-slate-200 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="p-8 rounded-2xl bg-[#0F172A] dark:bg-[#0F172A] light:bg-white border-2 border-blue-500 space-y-6 flex flex-col justify-between relative overflow-hidden shadow-md">
              ...
              <button
                onClick={() => onNavigateToAuth('signup')}
                className="w-full py-3 text-xs font-bold text-white bg-blue-700 hover:bg-blue-800 rounded-xl transition-colors cursor-pointer shadow-md"
              >
                Assinar Plano Pro
              </button>
            </div>
            ...
            <ul className="space-y-2 text-xs text-[#CBD5E1] dark:text-[#CBD5E1] light:text-slate-700">
              ...
              <li>
                <button
                  ...
                  className="inline-block py-1 text-blue-700 dark:text-blue-400 font-bold hover:underline cursor-pointer"
                >
            ...
            <ul className="space-y-2 text-xs text-[#CBD5E1] dark:text-[#CBD5E1] light:text-slate-700">
              ...
              <li>
                <a
                  ...
                  className="inline-block py-1 text-red-600 dark:text-red-400 hover:underline cursor-pointer font-semibold"
                >
