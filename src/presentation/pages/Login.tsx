    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-950 text-slate-100 p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex h-12 w-12 rounded-2xl bg-gradient-to-tr from-brand-600 to-indigo-500 items-center justify-center font-display font-bold text-white text-xl shadow-xl shadow-brand-500/20 mb-4">
            CM
          </div>
          <h1 className="font-display font-bold text-3xl tracking-tight bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">
            CareerMatch AI
          </h1>
        ...
        <div className="glass-panel p-8 rounded-3xl shadow-2xl relative">
          ...
          {isSignUp ? (
            ...
            <form onSubmit={signUpForm.handleSubmit(handleSignUpSubmit)} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-brand-600 to-indigo-600 hover:from-brand-500 hover:to-indigo-500 text-white font-medium text-sm transition-all flex items-center justify-center gap-2 shadow-lg shadow-brand-500/20 disabled:opacity-50"
              >
          ...
          <div className="relative my-6 flex items-center justify-center">
            ...
            <span className="relative px-3 text-[10px] uppercase font-semibold text-slate-500 bg-slate-950/80 backdrop-blur-md rounded-full">
              Ou continue com
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              disabled={loading}
              className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-slate-900/40 hover:bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-300 text-xs font-semibold transition-all disabled:opacity-50"
            >
        ...
        <p className="text-center text-xs text-slate-500 mt-6">
          ...
          <button
            ...
            className="text-brand-500 hover:underline font-semibold ml-1.5 focus:outline-none"
          >
