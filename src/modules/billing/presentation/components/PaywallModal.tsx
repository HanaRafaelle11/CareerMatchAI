...
export function PaywallModal({
    ...
    switch (feature) {
      ...
      case 'applications':
        return {
          ...
          defaultPrimaryBtn: 'Fazer Upgrade para Pro (A partir de R$ 9,90/semana)',
  ...
  const displayPrimaryBtn = primaryButtonText || details.defaultPrimaryBtn || 'Fazer Upgrade para Pro (A partir de R$ 9,90/semana)';
