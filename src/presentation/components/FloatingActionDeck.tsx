...
export function FloatingActionDeck({
  ...
  return (
    <>
      <div 
        className="fixed bottom-[calc(64px+env(safe-area-inset-bottom,0px)+12px)] md:bottom-6 left-4 md:left-6 z-[60] flex flex-col items-start gap-2 font-sans select-none"
      >
        {isExpanded ? (
