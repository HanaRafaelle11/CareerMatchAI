      ...
      <div className="max-w-4xl mx-auto space-y-8 relative z-10">
        ...
        <div className="space-y-8 text-xs sm:text-sm text-muted-foreground leading-relaxed font-sans">
          ...
          <div className="p-6 rounded-[20px] bg-card border border-border shadow-sm space-y-3">
            ...
            <p>
              O <strong className="text-foreground">Vocentro</strong> utiliza o padrão internacional <strong>OAuth 2.0 da Google</strong> para oferecer uma experiência de entrada rápida, conveniente e altamente segura. Com o login do Google:
            </p>
          ...
          <div className="p-6 rounded-[20px] bg-card/80 border border-border shadow-sm space-y-4">
            <h2 className="text-base font-bold text-foreground flex items-center gap-2 font-display">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
              ...
              <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 space-y-2">
                <h3 className="font-bold text-xs uppercase tracking-wider text-emerald-500 flex items-center gap-1.5">
              ...
              <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/30 space-y-2">
                <h3 className="font-bold text-xs uppercase tracking-wider text-red-500 flex items-center gap-1.5">
                  <XCircle size={16} />
          ...
          <div className="p-6 rounded-[20px] bg-card border border-border shadow-sm space-y-3">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-muted-foreground">
              <li>Acesse a página oficial de segurança da Google: <a href="https://myaccount.google.com/permissions" target="_blank" rel="noopener noreferrer" className="text-brand-500 font-bold hover:underline inline-flex items-center gap-1">https://myaccount.google.com/permissions <ExternalLink size={12} /></a></li>
          ...
          <div className="p-6 rounded-[20px] bg-card border border-border shadow-sm space-y-3">
            ...
            <p className="text-muted-foreground">
              Envie uma solicitação para <a href="mailto:suporte@vocentro.com.br" className="text-brand-500 font-bold hover:underline">suporte@vocentro.com.br</a> com o assunto <em>"Exclusão de Conta"</em>. Sua conta e dados serão eliminados definitivamente em até 48 horas úteis.
            </p>
          </div>
