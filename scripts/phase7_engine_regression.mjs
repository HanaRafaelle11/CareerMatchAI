...
function runPhase7EngineRegression() {
  console.log('========================================================================');
  console.log('🔒 ETAPA 11: REGRESSÃO COMPLETA DO MOTOR V3 (GOLDEN + REAL WORLD + DETERMINISMO)');
  console.log('========================================================================\n');
  ...
  const outputPath = path.join(reportsDir, 'phase7_engine_regression.json');
  fs.writeFileSync(outputPath, JSON.stringify(report, null, 2), 'utf-8');
  console.log(`📄 Relatório de regressão do motor salvo em: ${outputPath}`);
}

runPhase7EngineRegression();
