            ...
            <>
              ...
              <div className="w-full">
                <button
                  ...
                  disabled={loading}
                  className="flex items-center justify-center gap-2 py-3 px-4 w-full rounded-[14px] bg-slate-950/50 hover:bg-slate-950 border border-slate-800 hover:border-slate-700 text-slate-300 text-xs font-semibold transition-all disabled:opacity-50 cursor-pointer min-h-[44px]"
                >
