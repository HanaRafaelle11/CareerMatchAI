    ...
    <div className="min-h-screen bg-slate-950 dark:bg-slate-950 light:bg-slate-50 text-slate-100 dark:text-slate-100 light:text-slate-800 font-sans relative selection:bg-brand-500/30 selection:text-white transition-colors duration-300">
      ...
      <header className="fixed top-0 left-0 right-0 h-14 bg-slate-950/90 dark:bg-slate-950/90 light:bg-white/95 backdrop-blur-md border-b border-slate-900 dark:border-slate-900 light:border-slate-200 flex items-center justify-between px-6 z-50">
        ...
        <nav className="hidden md:flex items-center gap-4" aria-label="Navegação Principal">
          <a href="#beneficios" className="text-xs font-semibold text-slate-300 hover:text-white transition-colors py-1.5 px-2 min-h-[36px] inline-flex items-center focus:ring-2 focus:ring-brand-500 focus:outline-none rounded-md">Benefícios</a>
          <a href="#como-funciona" className="text-xs font-semibold text-slate-300 hover:text-white transition-colors py-1.5 px-2 min-h-[36px] inline-flex items-center focus:ring-2 focus:ring-brand-500 focus:outline-none rounded-md">Como funciona</a>
          <a href="#recursos" className="text-xs font-semibold text-slate-300 hover:text-white transition-colors py-1.5 px-2 min-h-[36px] inline-flex items-center focus:ring-2 focus:ring-brand-500 focus:outline-none rounded-md">Recursos</a>
          <a href="#planos" className="text-xs font-semibold text-slate-300 hover:text-white transition-colors py-1.5 px-2 min-h-[36px] inline-flex items-center focus:ring-2 focus:ring-brand-500 focus:outline-none rounded-md">Planos</a>
          <a href="#faq" className="text-xs font-semibold text-slate-300 hover:text-white transition-colors py-1.5 px-2 min-h-[36px] inline-flex items-center focus:ring-2 focus:ring-brand-500 focus:outline-none rounded-md">FAQ</a>
        </nav>
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            aria-label="Fazer login na plataforma Vocentro"
          ...
          <button 
            ...
            aria-label="Criar conta gratuita no Vocentro"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-start gap-4 text-left">
            ...
            <div className="w-full flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-1">
              <button 
                onClick={() => onNavigateToAuth('signup')}
                aria-label="Criar conta grátis no Vocentro agora"
      ...
      {/* ── 3. COMO FUNCIONA (6 PASSO ENXUTOS) ── */}
      ...
      <section id="planos" className="py-8 px-6 max-w-5xl mx-auto z-10 space-y-6 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto font-sans">
          ...
          <div className="p-5 rounded-2xl bg-slate-900/80 border-2 border-brand-500 shadow-xl shadow-brand-500/10 flex flex-col justify-between space-y-4 relative">
            ...
            <button 
              onClick={() => onNavigateToAuth('signup')}
              aria-label="Aderir ao Plano Premium do Vocentro"
