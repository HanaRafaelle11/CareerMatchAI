import { LayoutDashboard, User, LogOut, Compass, FileText, Briefcase, Award } from 'lucide-react';
...
export function Navbar({ activeTab, setActiveTab, profile, onLogout }: NavbarProps) {
  const menuItems = [
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 border-r border-slate-800 dark:border-slate-800 light:border-slate-200 bg-slate-950/80 dark:bg-slate-950/80 light:bg-slate-50/90 backdrop-blur-md flex flex-col justify-between p-6 z-30">
